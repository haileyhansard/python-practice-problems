...
// NAIVE SOLUTION: Loop through every element, and then loop through every other element looking for a pair that sums to S. The running time for the below solution would be O(n^2) because in the worst case we are looping through the array twice to find a pair.
...
// FASTER SOLUTION in O(n) runtime
